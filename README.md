...
- Web Backend: https://github.com/phanhoang1366/OnlineJudge
- Web Frontend: https://github.com/phanhoang1366/OnlineJudgeFE
...
Truy cập cổng HTTP 80 hoặc cổng HTTPS 443 của máy chủ thông qua trình duyệt và bạn có thể bắt đầu sử dụng. Đường dẫn trang quản lý là `/admin`, tên người dùng quản trị viên được tự động thêm vào trong quá trình cài đặt là `admin` và mật khẩu là `adminadmin`. **Vui lòng thay đổi mật khẩu ngay**.
